...
export default {
  ...
  new: {
    ...
    strategyDescPlaceholder: 'Please enter strategy description',
    codeVisualization: 'Code Visualization',
    flowchart: 'Flowchart',
    dependency: 'Dependencies',
    flowchartPlaceholder: 'Code flowchart will be displayed here',
    dependencyPlaceholder: 'Code dependencies will be displayed here',
    reset: 'Reset',
    save: 'Save',
    deployTest: 'Deploy Test',
    formReset: 'Form has been reset',
    nameRequired: 'Please enter strategy name',
    codeRequired: 'Strategy code cannot be empty',
    saveSuccess: 'Strategy saved successfully',
    saveFailed: 'Save failed',
    pageRedirect: 'Page Redirect',
    redirectNotice: 'The page will automatically redirect in 3 seconds, please do not close',
    codeValidationPass: 'Code validation passed',
    codeValidationPassMsg: 'Your strategy code format is correct, you may proceed.',
    codeValidationFail: 'Code validation failed',
    codeWarnings: 'Code warnings',
    found: 'Found',
    errorCount: 'error(s)',
    warnCount: 'warning(s)',
    codeEditing: {
      strategyCode: 'Strategy Code',
      templateButton: 'Code Template',
      fullscreenEdit: 'Fullscreen Edit',
      exitFullscreen: 'Exit Fullscreen',
      DOMerror: 'Code rendering error',
    ...
    snippetsCards: {
      ...
      dialog: {
        create: {
          ...
          name: 'Snippet Name',
          namePlaceholder: 'Please enter snippet name',
          description: 'Code Description',
          descriptionPlaceholder: 'Please enter code description',
          confirm: 'Confirm',
          cancel: 'Cancel',
        },
        delete: {
          ...
          message:
            'Are you sure you want to delete code snippet "{name}"? This action cannot be undone.',
          confirm: 'Confirm',
          cancel: 'Cancel',
        },
        button: {
        ...
        tooltip: {
          load: 'Click to load this code snippet',
          edit: 'Edit',
          delete: 'Delete',
        },
        table: {
          emptyText: 'No code snippets yet',
        },
      },
      messages: {
        createSuccess: 'Code snippet created successfully',
        deleteSuccess: 'Code snippet deleted successfully',
        loadSuccess: 'Loaded code snippet: {name}',
      },
    },
  },
  history: {
    ...
    betaCoefficient: 'Beta Coefficient',
    holdingPeriod: 'Holding Period',
    positionUtilization: 'Position Utilization',
    days: 'Days',
    viewDetail: 'Details',
    delete: 'Delete',
    confirmDelete: 'Confirm deletion?',
    queryError: 'Failed to query backtest records',
    queryFailed: 'Query failed',
    deleteSuccess: 'Successfully deleted',
    deleteError: 'Failed to delete backtest record',
    deleteFailed: 'Deletion failed',
    initError: 'Backtest storage initialization failed',
    initFailed: 'Initialization failed',
    shareHoldingLimit: 'Share Holding Limit',
    profitHoldThreshold: 'Profit Hold Threshold',
    trailingStopPercent: 'Trailing Stop Percentage',
    stopLossLimit: 'Stop Loss Limit',
    ...
    bollingerBandsPeriod: 'Bollinger Bands Period',
    standardDeviationMultiple: 'Standard Deviation Multiple',
  },
}
