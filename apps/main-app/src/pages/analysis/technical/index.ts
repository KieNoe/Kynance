  ...
  stock: [
    {
      label: '腾讯控股(Tencent)',
      value: '07000.HK',
      title: '腾讯控股 (Tencent, 中国大陆, China, HK:07000)',
    },
    {
      label: '阿里巴巴(Alibaba)',
      value: '09988.HK',
      title: '阿里巴巴 (Alibaba, 中国大陆, China, HK:09988)',
    },
    {
      label: '贵州茅台(Moutai)',
      value: '600519.SH',
    ...
    { label: '美团(Meituan)', value: '3690.HK', title: '美团 (Meituan, 中国大陆, China, HK:3690)' },
    { label: '京东(JD.com)', value: '9618.HK', title: '京东 (JD.com, 中国大陆, China, HK:9618)' },
    {
      label: '拼多多(Pinduoduo)',
      value: 'PDD.NASDAQ',
      title: '拼多多 (Pinduoduo, 中国大陆, China, NASDAQ:PDD)',
    },
    { label: '比亚迪(BYD)', value: '002594.SZ', title: '比亚迪 (BYD, 中国大陆, China, SZ:002594)' },
    {
      label: '宁德时代(CATL)',
      value: '300750.SZ',
    ...
    },
    {
      label: '苹果 (Apple)',
      value: 'AAPL.NASDAQ',
      title: '苹果 (Apple, 美国, America, NASDAQ:AAPL)',
    },
    {
      label: '微软 (Microsoft)',
      value: 'MSFT.NASDAQ',
    ...
    { label: '辉瑞 (Pfizer)', value: 'PFE.NYSE', title: '辉瑞 (Pfizer, 美国, America, NYSE:PFE)' },
    {
      label: '雀巢 (Nestlé)',
      value: 'NESN.SWX',
      title: '雀巢 (Nestlé, 瑞士, Switzerland, SWX:NESN)',
    },
    { label: '路威酩轩 (LVMH)', value: 'MC.EPA', title: '路威酩轩 (LVMH, 法国, France, EPA:MC)' },
    {
      label: '阿斯麦 (ASML)',
      value: 'ASML.AMS',
      title: '阿斯麦 (ASML, 荷兰, Netherlands, AMS:ASML)',
    },
    {
      label: '西门子 (Siemens)',
      value: 'SIE.ETR',
    ...
    { label: 'SAP ', value: 'SAP.ETR', title: 'SAP (SAP, 德国, Germany, ETR:SAP)' },
    {
      label: '三星电子 (Samsung)',
      value: '005930.KRX',
    ...
    { label: '索尼 (Sony)', value: '6758.TYO', title: '索尼 (Sony, 日本, Japan, TYO:6758)' },
    {
      label: '台积电 (TSMC)',
      value: '2330.TPE',
    ...
    },
    {
      label: '淡水河谷 (Vale)',
      value: 'VALE.NYSE',
      title: '淡水河谷 (Vale, 巴西, Brazil, NYSE:VALE)',
    },
    {
