  ...
  stock: [
    {
      label: '腾讯控股(Tencent)',
      value: '0700',
      detail: '腾讯控股 (Tencent, 中国大陆, China, HK:0700)',
    },
    {
      label: '阿里巴巴(Alibaba)',
      value: 'BABA',
      detail: '阿里巴巴 (Alibaba, 中国大陆, China, NYSE:BABA)',
    },
    {
      label: '贵州茅台(Moutai)',
      value: '600519',
      detail: '贵州茅台 (Moutai, 中国大陆, China, SH:600519)',
    },
    { label: '美团(Meituan)', value: '3690', detail: '美团 (Meituan, 中国大陆, China, HK:3690)' },
    { label: '京东(JD.com)', value: '9618', detail: '京东 (JD.com, 中国大陆, China, HK:9618)' },
    {
      label: '拼多多(Pinduoduo)',
      value: 'PDD',
      detail: '拼多多 (Pinduoduo, 中国大陆, China, NASDAQ:PDD)',
    },
    { label: '比亚迪(BYD)', value: '002594', detail: '比亚迪 (BYD, 中国大陆, China, SZ:002594)' },
    {
      label: '宁德时代(CATL)',
      value: '300750',
      detail: '宁德时代 (CATL, 中国大陆, China, SZ:300750)',
    },
    {
      label: '小米集团(Xiaomi)',
      value: '1810',
      detail: '小米集团 (Xiaomi, 中国大陆, China, HK:1810)',
    },
    {
      label: '中国平安(Ping An)',
      value: '601318',
      detail: '中国平安 (Ping An, 中国大陆, China, SH:601318)',
    },
    {
      label: '招商银行(CMB)',
      value: '600036',
      detail: '招商银行 (CMB, 中国大陆, China, SH:600036)',
    },
    {
      label: '药明康德(WuXi AppTec)',
      value: '603259',
      detail: '药明康德 (WuXi AppTec, 中国大陆, China, SH:603259)',
    },
    {
      label: '隆基绿能(LONGi)',
      value: '601012',
      detail: '隆基绿能 (LONGi, 中国大陆, China, SH:601012)',
    },
    {
      label: '海康威视(Hikvision)',
      value: '002415',
      detail: '海康威视 (Hikvision, 中国大陆, China, SZ:002415)',
    },
    {
      label: '伊利股份(Yili)',
      value: '600887',
      detail: '伊利股份 (Yili, 中国大陆, China, SH:600887)',
    },
    { label: '苹果 (Apple)', value: 'AAPL', detail: '苹果 (Apple, 美国, America, NASDAQ:AAPL)' },
    {
      label: '微软 (Microsoft)',
      value: 'MSFT',
      detail: '微软 (Microsoft, 美国, America, NASDAQ:MSFT)',
    },
    {
      label: '谷歌 (Alphabet)',
      value: 'GOOGL',
      detail: '谷歌 (Alphabet, 美国, America, NASDAQ:GOOGL)',
    },
    {
      label: '亚马逊 (Amazon)',
      value: 'AMZN',
      detail: '亚马逊 (Amazon, 美国, America, NASDAQ:AMZN)',
    },
    {
      label: '特斯拉 (Tesla)',
      value: 'TSLA',
      detail: '特斯拉 (Tesla, 美国, America, NASDAQ:TSLA)',
    },
    {
      label: '英伟达 (NVIDIA)',
      value: 'NVDA',
      detail: '英伟达 (NVIDIA, 美国, America, NASDAQ:NVDA)',
    },
    {
      label: 'Meta (Facebook)',
      value: 'META',
      detail: 'Meta (Facebook, 美国, America, NASDAQ:META)',
    },
    {
      label: '伯克希尔·哈撒韦 (Berkshire Hathaway)',
      value: 'BRK.A',
      detail: '伯克希尔·哈撒韦 (Berkshire Hathaway, 美国, America, NYSE:BRK.A)',
    },
    {
      label: '摩根大通 (JPMorgan Chase)',
      value: 'JPM',
      detail: '摩根大通 (JPMorgan Chase, 美国, America, NYSE:JPM)',
    },
    {
      label: '强生 (Johnson & Johnson)',
      value: 'JNJ',
      detail: '强生 (Johnson & Johnson, 美国, America, NYSE:JNJ)',
    },
    {
      label: '沃尔玛 (Walmart)',
      value: 'WMT',
      detail: '沃尔玛 (Walmart, 美国, America, NYSE:WMT)',
    },
    {
      label: '宝洁 (Procter & Gamble)',
      value: 'PG',
      detail: '宝洁 (Procter & Gamble, 美国, America, NYSE:PG)',
    },
    {
      label: '埃克森美孚 (ExxonMobil)',
      value: 'XOM',
      detail: '埃克森美孚 (ExxonMobil, 美国, America, NYSE:XOM)',
    },
    {
      label: '可口可乐 (Coca-Cola)',
      value: 'KO',
      detail: '可口可乐 (Coca-Cola, 美国, America, NYSE:KO)',
    },
    { label: '辉瑞 (Pfizer)', value: 'PFE', detail: '辉瑞 (Pfizer, 美国, America, NYSE:PFE)' },
    {
      label: '雀巢 (Nestlé)',
      value: 'NESN',
      detail: '雀巢 (Nestlé, 瑞士, Switzerland, SWX:NESN)',
    },
    { label: '路威酩轩 (LVMH)', value: 'MC', detail: '路威酩轩 (LVMH, 法国, France, EPA:MC)' },
    { label: '阿斯麦 (ASML)', value: 'ASML', detail: '阿斯麦 (ASML, 荷兰, Netherlands, AMS:ASML)' },
    {
      label: '西门子 (Siemens)',
      value: 'SIE',
      detail: '西门子 (Siemens, 德国, Germany, ETR:SIE)',
    },
    { label: 'SAP ', value: 'SAP', detail: 'SAP (SAP, 德国, Germany, ETR:SAP)' },
    {
      label: '三星电子 (Samsung)',
      value: '005930',
      detail: '三星电子 (Samsung, 韩国, South Korea, KRX:005930)',
    },
    {
      label: '丰田汽车 (Toyota)',
      value: '7203',
      detail: '丰田汽车 (Toyota, 日本, Japan, TYO:7203)',
    },
    { label: '索尼 (Sony)', value: '6758', detail: '索尼 (Sony, 日本, Japan, TYO:6758)' },
    {
      label: '台积电 (TSMC)',
      value: '2330',
      detail: '台积电 (TSMC, 中国台湾, Taiwan, TPE:2330)',
    },
    {
      label: '信实工业 (Reliance)',
      value: 'RELIANCE',
      detail: '信实工业 (Reliance, 印度, India, NSE:RELIANCE)',
    },
    {
      label: '必和必拓 (BHP)',
      value: 'BHP',
      detail: '必和必拓 (BHP, 澳大利亚, Australia, ASX:BHP)',
    },
    { label: '淡水河谷 (Vale)', value: 'VALE', detail: '淡水河谷 (Vale, 巴西, Brazil, NYSE:VALE)' },
    {
      label: '沙特阿美 (Saudi Aramco)',
      value: '2222',
      detail: '沙特阿美 (Saudi Aramco, 沙特, Saudi Arabia, TADAWUL:2222)',
    },
  ],
}
...
const onSearch = () => {
  stockOptions.value = OPTIONS.stock.filter((item) => item.detail.indexOf(search.value) !== -1)
}
onMounted(() => {
